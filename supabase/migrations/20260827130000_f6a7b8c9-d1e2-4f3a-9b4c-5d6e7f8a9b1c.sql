-- =========================================================================
-- ASSIGNMENTS SYSTEM
-- assignments: created by the course owner (teacher/admin), applies to all
--   actively-enrolled students in the course unless target_student_ids is set.
-- assignment_submissions: one row per (assignment, student); students only
--   ever see/write their OWN row; teachers/admin see all rows for their course.
-- =========================================================================
...
CREATE TABLE IF NOT EXISTS public.assignments (
  ...
  -- NULL = كل الطلاب المسجّلين فعليًا في الكورس؛ وإلا فمجموعة محددة بالـid
...
-- helper: is this assignment actually targeted at this student?
...
-- late auto-flag + auto-stamp graded_at
...
-- notifications: new assignment -> targeted students; submission -> teacher; graded -> student + parent
