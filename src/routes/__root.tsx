...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Edu Mindly التعليمية" },
      ...
      { name: "twitter:title", content: "Edu Mindly | أقوى منصة تعليمية في مصر لكل المراحل" },
      { name: "twitter:description", content: "Edu Mindly منصة تعليمية متطورة تجمع أفضل المدرسين في مصر، دروس وفيديوهات تفاعلية وبث مباشر لكل المراحل الدراسية: ابتدائي وإعدادي وثانوي." },
